$(document).ready(function(){$('.fa-exclamation-triangle').click(function(){askForChange($(this),applyCellChange);});$('.action-button').click(function(){askForChange($(this),applyButtonChange);});updateProgressBar();});function askForChange(item,callbackFunction){var category=item.data('category');var id=null;if(item.parent().is('td')){var row=item.closest('tr');id=row.data('id');}
